                        ...
                        _c(
                          ...
                          [
                            _c("input", {
                              directives: [
                                {
                                  name: "model",
                                  rawName: "v-model",
                                  value: _vm.form.net_amount,
                                  expression: "form.net_amount"
                                }
                              ],
                              staticClass:
                                "border text-dark bg-success rounded-0 form-control form-control-sm",
                              ...
                              domProps: { value: _vm.form.net_amount },
                              on: {
                                input: function($event) {
                                  if ($event.target.composing) {
                                    return
